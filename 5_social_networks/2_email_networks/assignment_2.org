...
#+BEGIN_SRC ipython :session networkconnectivity :ipyfile /tmp/one.png :exports both :results raw drawer
one = answer_one()
...
#+BEGIN_SRC ipython :session networkconnectivity :ipyfile /tmp/strongly_undirected.png :exports both :results raw drawer
